/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cfee7d5e7b363f56bf75a769430d1fe2)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	TRACKER_DB: D1Database;
	ASSETS: Fetcher;
	LINK_TRACKER_ADMIN_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINK_TRACKER_ADMIN_TOKEN">> {}
}
